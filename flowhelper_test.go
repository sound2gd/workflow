...
func TestAddFlow(t *testing.T) {
	...
	if err1 != nil {
		t.Errorf("add flow failed! detail info :", err1)
	}
}
...
func TestUpdateFlow(t *testing.T) {
	...
	if err1 != nil {
		t.Errorf("update flow failed! detail info :", err1)
	}
}
...
func TestGetMyAgent(t *testing.T) {
	...
	if err1 != nil {
		t.Errorf("get myagent failed! detail info :", err1)
	}
	fmt.Println(myagent)
}
...
func TestGetMyAffair(t *testing.T) {
	...
	if err1 != nil {
		t.Errorf("get myaffair failed! detail info :", err1)
	}
...
func TestGetWorkFlow(t *testing.T) {
	...
	if err1 != nil {
		t.Errorf("get workflowinfo failed! detail info :", err1)
	}
...
func TestGetWorkFlow1(t *testing.T) {
	...
	if err != nil {
		t.Errorf("get workflow failed! , detail info :", err)
	}

	flow, err1 := flowhelper.GetWorkFlowDetail("2413f773-4255-4f6a-b514-c69bfc4e4ca6", wf)
	if err1 != nil {
		t.Errorf("get workflow detail failed! detail info :", err1)
	}
	fmt.Println(flow)
}
...
func TestAddAffair(t *testing.T) {
	...
	if err1 != nil {
		t.Errorf("add affair failed! detail info :", err1)
	}
}
